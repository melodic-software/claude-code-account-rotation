...
- The README now says how to move from one release to the next and how to uninstall (#36, #37).
  ...
  untouched. Uninstall removes each side's app data and the installed executables, and leaves
  the profiles root, the live directory, and Claude Code's state file.
